...
ssh internal-host
  └─ authunnel-client
       └─ HTTPS WebSocket ──→  Ivanti TM (TLS termination, :443)
...
| Security groups (inbound from Ivanti, outbound to permitted hosts) | Infrastructure / Network team | Standard config |
| Deploy binary + systemd unit | Authunnel maintainer | ~1 hour |
